...
I will address this in the Builder Callback Notation video. For now, you can set up functions and extraReducers, but please be aware that we will refactor the code later. Therefore, don't be surprised if the following code does not work:
